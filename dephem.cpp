...
void dph::EphemerisRelease::calculateBaseEarth(double JED, double* resultArray, 
	...
	bool calculateState, double* resultArray) const
{
	...
	if (targetBodyIndex == 12 || centerBodyIndex == 12)
	{
		...
		else if (notSSBARY ==  3)	calculateBaseEarth(JED, resultArray, calculateState);
	...
	else
	{
		...
		for (unsigned i = 0; i <= 1; ++i)
		{
			...
			{
			case 3:		calculateBaseEarth(JED, currentArray, calculateState);		break;
